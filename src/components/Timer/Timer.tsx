    ...
    <Fragment>
      <Paper elevation={1} className={styles.itemContainer} sx={{height: '142px', minHeight: '142px'}}>
        <Grid direction={"column"} sx={{minHeight: '105px'}}>
              ...
              <Button onClick={handleTimerStart} variant="outlined">Start</Button>
              <Button onClick={handleTimerPause} variant="outlined">Pause</Button>
              <Button onClick={handleTimerFinish} variant="outlined">Finish</Button>
              <Button onClick={handleTimerReset} variant="outlined">Reset</Button>
          </Grid>
      </Paper>
